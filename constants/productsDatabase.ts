...
export const PRODUCTS_DATABASE: Record<string, ProductDatabaseItem> = {
  ...
  "куриное филе": { icon: "🍗", proteins: 23.1, fats: 1.2, carbs: 0.0, isFood: true },
  ...
  "пиво": { icon: "🍺", proteins: 0.3, fats: 0.0, carbs: 4.4, isFood: true },
  "водка": { icon: "🍸", proteins: 0.0, fats: 0.0, carbs: 0.1, isFood: true },
  "шоколад": { icon: "🍫", proteins: 5.4, fats: 35.3, carbs: 52.6, isFood: true },
  "печенье": { icon: "🍪", proteins: 7.5, fats: 11.8, carbs: 74.0, isFood: true },
  "булочка": { icon: "🥐", proteins: 8.1, fats: 7.7, carbs: 50.1, isFood: true },
  "жвачка": { icon: "🍬", proteins: 0.0, fats: 0.0, carbs: 60.0, isFood: true },
  ...
  "стирального порошка": { icon: "🧼", proteins: null, fats: null, carbs: null, isFood: false },
  "гель для стирки": { icon: "🧴", proteins: null, fats: null, carbs: null, isFood: false },
  "сигареты": { icon: "🚬", proteins: null, fats: null, carbs: null, isFood: false },
  "стики": { icon: "📦", proteins: null, fats: null, carbs: null, isFood: false },
